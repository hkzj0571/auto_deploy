...
/* scopeId */
var __vue_scopeId__ = "data-v-c97d741c"
...
Component.options.__file = "resources/js/admin/views/jingse/create.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-c97d741c", Component.options)
  } else {
    hotAPI.reload("data-v-c97d741c", Component.options)
  }
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(72)("edb74224", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-c97d741c\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../node_modules/sass-loader/lib/loader.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./create.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-c97d741c\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../node_modules/sass-loader/lib/loader.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./create.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      ...
      loading: false,
      rules: {
        cover: [{ required: true, message: '请上传景点图片', trigger: 'change' }],
        title: [{ required: true, message: '请输入景点名称', trigger: 'change' }],
        describe: [{ required: true, message: '请输入景点描述', trigger: 'change' }],
  ...
  methods: {
    store: function store() {
      ...
      this.$refs['form'].validate(function (valid) {
        ...
        _this.loading = true;
        _this.$http.post(_this.$api.jingse.store, _this.form).then(function (r) {
          _this.loading = false;
          _this.$message.success('操作成功');
          _this.$router.push({ name: 'jingse' });
        }).catch(function (e) {
          _this.loading = false;
    ...
    [
      ...
      _c(
        ...
        [
          ...
          _c(
            "el-form-item",
            { attrs: { label: "景点描述", prop: "describe" } },
            [
              _c("el-input", {
                attrs: {
                  type: "textarea",
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-c97d741c", module.exports)
  }
}
