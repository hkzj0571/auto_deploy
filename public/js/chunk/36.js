...
Component.options.__file = "resources/js/admin/views/shops/form.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-3a0650d5", Component.options)
  } else {
    hotAPI.reload("data-v-3a0650d5", Component.options)
  }
...
Component.options.__file = "resources/js/admin/views/shops/index.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6d63fe11", Component.options)
  } else {
    hotAPI.reload("data-v-6d63fe11", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
  ...
  data: function data() {
    return {
      ...
      rules: {
        ...
        url: [{ required: true, message: '请上传店铺名称', trigger: 'change' }],
        link: [{ required: true, message: '请输入店铺链接', trigger: 'change' }]
      }
    };
  },
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-3a0650d5", module.exports)
  }
}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__form__ = __webpack_require__(232);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      ...
      columns: [{ prop: 'id', label: 'ID' }, { prop: 'name', label: '店铺名称' }, { prop: 'link', label: '店铺链接' }, { prop: 'created_at', label: '创建时间', is_date: true }, { prop: 'actions', label: '操作', type: 3, width: 300 }],
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-6d63fe11", module.exports)
  }
}
