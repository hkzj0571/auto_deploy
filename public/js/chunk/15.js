...
Component.options.__file = "resources/js/admin/views/articles/index.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6a34c77f", Component.options)
  } else {
    hotAPI.reload("data-v-6a34c77f", Component.options)
  }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-6a34c77f", module.exports)
  }
}
