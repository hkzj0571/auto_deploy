...
Component.options.__file = "resources/js/admin/views/mains/index.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-7eb98b6e", Component.options)
  } else {
    hotAPI.reload("data-v-7eb98b6e", Component.options)
  }
...
/* harmony default export */ __webpack_exports__["default"] = ({
  data: function data() {
    return {
      ...
      columns: [{ prop: 'id', label: 'ID' }, { prop: 'title', label: '标题' }, { prop: 'created_at', label: '创建时间', is_date: true }, { prop: 'actions', label: '操作', type: 3, width: 300 }],
  ...
  methods: {
    destroy: function destroy(row) {
      ...
      this.$confirm('\u6B64\u64CD\u4F5C\u5C06\u5220\u9664\u9875\u9762\u300E' + row.title + '\u300F, \u662F\u5426\u7EE7\u7EED?', '删除页面', {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-7eb98b6e", module.exports)
  }
}
