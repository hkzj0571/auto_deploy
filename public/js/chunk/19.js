...
/* scopeId */
var __vue_scopeId__ = "data-v-548c721e"
...
Component.options.__file = "resources/js/admin/views/mains/edit.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-548c721e", Component.options)
  } else {
    hotAPI.reload("data-v-548c721e", Component.options)
  }
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(72)("61bb1992", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-548c721e\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../node_modules/sass-loader/lib/loader.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./edit.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-548c721e\",\"scoped\":true,\"hasInlineConfig\":true}!../../../../../node_modules/sass-loader/lib/loader.js!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./edit.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
      ...
      return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return _this.$http.get(_this.$api.pages.show(_this.$route.params.id));
  ...
  methods: {
    store: function store() {
      ...
      this.$refs['form'].validate(function (valid) {
        ...
        _this2.loading = true;
        _this2.$http.post(_this2.$api.pages.update(_this2.$route.params.id), _this2.form).then(function (r) {
          _this2.loading = false;
          _this2.$message.success('操作成功');
          _this2.$router.push({ name: 'pages' });
        }).catch(function (e) {
          _this2.loading = false;
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-548c721e", module.exports)
  }
}
