		...
		<div class="row">
			<div class="col-md-12" style="padding-top: 50px; ">
				<div class="section-heading text-center">
					<!-- <p>登入</p> -->
					<p style="color: white; !important">Login</p> 
				</div>
			</div>
		</div>
		<!--  row heading end -->
		<div class="row">
			<div class="wow fadeIn">
				<div class="contact-box">
					<form  id="contactForm" data-toggle="validator" method="get" action="">
						<div class="col-md-4 col-md-offset-4">
							
							<div class="form-group" style="padding-bottom: 10px;">
								<input type="phone" id="name" name="name" class="form-control" placeholder="手机号码" required data-error="请输入您的手机号码">
						...
						<div class="col-md-12  text-right wow fadeInUp text-center"> 
							<button class="btn btn-black " id="submit" type="submit" value="Submit">登 入</button>
